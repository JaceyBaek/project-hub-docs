...
|---|---|---|---|---|---|---|---|---|
| 서비스종료 | P2605061 | gmail_cleaner | projects/gmail_cleaner | Jacey | 2026-05-06 | 2026-06-10 | 운영종료 | Python/MCP 방식 중단 — 기존 GAS 스크립트(Apps Script)로 운영 유지 결정. CI·테스트·MCP 11개 tool 구현 완료 후 종료 |
