...
| 프로젝트명 | 폴더 | 담당 | 시작일 | 요약 |
|---|---|---|---|---|
| google_drive_backup | projects/google_drive_backup | Jacey | 2026-04-17 | D:\03.project-hub\ 전체를 Google Drive에 자동 백업하는 Python 스크립트, 세션 종료 시 자동 실행 |
| wiki_faq_builder | projects/wiki_faq_builder | Jacey | 2026-04-22 | Confluence 위키 페이지를 읽어 미소 AI로 요약·FAQ 변환 후 지정 페이지에 저장하는 도구, 월~금 12:10 자동 실행 |

## 서비스종료

| 프로젝트명 | 폴더 | 담당 | 시작일 | 종료일 | 요약 |
|---|---|---|---|---|---|
