...
|---|---|---|---|---|---|---|---|
| 진행중 | P2606081 | transit_finder | github.com/JaceyBaek/transit_finder | Jacey | 2026-06-08 | 기획 | 시율이와 함께하는 대중교통 귀가 경로 탐색 도구 |
| 진행중 | P2606021 | video_clipper | github.com/JaceyBaek/video_clipper | Jacey | 2026-06-02 | 개발 | 인터뷰 영상 STT 기반 장면 추출·편집 도구 |
| 진행중 | P2605262 | eacct | projects/eacct | Jacey | 2026-05-26 | 개발 | e-Acct 시스템 소스 수정·기능개선 작업 관리 — API 추가, 버그픽스, 리팩토링 이력 통합 |
| 진행중 | P2605261 | eacct_source_analyzer | github.com/JaceyBaek/eacct_source_analyzer | Jacey | 2026-05-26 | 개발 | eAcct 소스 분석·리뷰·API 생성 |
...
| 상태 | 코드 | 프로젝트명 | 폴더 | 담당 | 시작일 | 단계 | 요약 |
|---|---|---|---|---|---|---|---|
| 활성 | P2606041 | wiki_builder | github.com/JaceyBaek/wiki_builder | Jacey | 2026-06-04 | 운영 | e-Acct 일일회의·주간보고 Confluence 페이지를 FAQ·MBO로 동시 변환하는 통합 빌더 (wiki_faq_builder + wiki_mbo_builder 통합) |

## 서비스종료

| 상태 | 코드 | 프로젝트명 | 폴더 | 담당 | 시작일 | 종료일 | 단계 | 요약 |
|---|---|---|---|---|---|---|---|---|
| 서비스종료 | P2605061 | gmail_cleaner | github.com/JaceyBaek/gmail_cleaner | Jacey | 2026-05-06 | 2026-06-10 | 운영종료 | Python/MCP 방식 중단 — 기존 GAS 스크립트(Apps Script)로 운영 유지 결정. CI·테스트·MCP 11개 tool 구현 완료 후 종료 |
