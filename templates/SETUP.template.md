...
전체 현황 필요 시: "전체 To-Do 보여줘" → {{ASSISTANT_KR}}가 TODO_GLOBAL + 진행중·운영중 프로젝트 todo.md 통합 출력.
...
전체 현황 필요 시: "전체 이슈 보여줘" → {{ASSISTANT_KR}}가 ISSUES_GLOBAL + 진행중·운영중 프로젝트 issues.md 통합 출력.
