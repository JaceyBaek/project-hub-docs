...
| G-005 | project-hub | D:\03.Lab 탐색기에서 삭제 | 낮음 | 대기 | - | - |
...
| G-009 | project-hub | hub_config.yml email.enabled dead config 정리 | 낮음 | 대기 | - | - |
| G-010 | project-hub | templates/deliverables/ HTML 템플릿 파일 배치 (Jacey 제작 후) | 높음 | 대기 | - | - |
...
| G-016 | 개인 | {assistant} CLAUDE.md 정리 — 팀 공용으로 이관된 내용 제거, {assistant} 전용 내용만 유지 | 보통 | 대기 | - | - |
