<!-- _sidebar.md — Docsify 사이드바 네비게이션 -->
<!-- 자동 생성됨 (platform/scripts/webview/generate_sidebar.py) — 직접 편집 금지 -->
<!-- 새 메뉴 추가 시: 해당 .md 파일 상단에 sidebar_title / sidebar_order 메타데이터 추가 후 스크립트 재실행 -->
...
- **히스토리**
  ...
  - [2026년 4월](platform/history/202604_history.md)
